...
PROTOCOL_ID = "a_share_sentiment_v0_4_3_after_close_v1"
STRATEGY_ID = "a_share_sentiment"
STRATEGY_VERSION = "0.4.3"
IMMUTABLE_TAG = "a-share-sentiment-v0.4.3"
...
def submit_observation(
    *,
    ...
    observation_id = f"asent_fwd_{today.strftime('%Y%m%d')}_v043"
