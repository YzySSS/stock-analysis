...
DATA_QUALITY_JOB="5 4 * * * cd $PROJECT_ROOT && PYTHONPATH=$PROJECT_ROOT $PYTHON_BIN scripts/run_data_quality_audit.py >> $LOG_DIR/data_quality_audit.log 2>&1
