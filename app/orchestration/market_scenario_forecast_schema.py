...
DDL = [
    ...
    CREATE TABLE IF NOT EXISTS market_leadership_state_daily (
        ...
        cycle_label VARCHAR(32) DEFAULT NULL,
        ...
        price_score DECIMAL(10,4) DEFAULT NULL,
        price_evidence_status VARCHAR(32) DEFAULT NULL,
        price_metrics_json JSON DEFAULT NULL,
        breadth_metrics_json JSON DEFAULT NULL,
