...
TASK_SCHEDULES = [
    ...
    {"task_name": "market_scenario_forecast_shadow_update", "task_label": "市场概率情景与主线强度/周期", "schedule": "每天 06:10；交易日 18:50"},
    ...
    {"task_name": "etf_rotation_data_sync", "task_label": "行业 ETF 轮动数据同步", "schedule": "每天 05:40；交易日 16:20、18:20"},
