...
TASK_SCHEDULES = [
    ...
    {"task_name": "stock_status_pit_backfill", "task_label": "历史股票状态真相层", "schedule": "每天 04:35；全量回填按需后台运行"},
    {"task_name": "fundamental_pit_backfill", "task_label": "公告日基本面真相层", "schedule": "每天 04:40；全量回填按需后台运行"},
    {"task_name": "data_quality_audit", "task_label": "核心数据质量审计", "schedule": "每天 04:55；交易日 18:45"},
