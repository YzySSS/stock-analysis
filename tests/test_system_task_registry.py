...
class SystemTaskRegistryTests(unittest.TestCase):
    ...
    def test_technical_feature_refresh_is_in_print_only_cron_output(self):
        ...
        self.assertIn('SENTIMENT_V06_SNAPSHOT_JOB="32 9 * * 1-5', source)
        self.assertIn("--strategy-id a_share_sentiment_v06 --allow-shadow", source)
        self.assertIn("sentiment_candidate_snapshot_v06.log", source)
        self.assertIn('"$SENTIMENT_V06_SNAPSHOT_JOB"', source)
