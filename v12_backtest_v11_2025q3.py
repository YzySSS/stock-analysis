...
print("="*70)
print("V11_IC_Optimized 2025年Q3回测")
print("="*70)
...
FROM stock_kline 
WHERE trade_date BETWEEN '2025-05-01' AND '2025-09-30'
AND amount >= 500000
...
# 2. 回测
print("\n[2/3] 运行回测...")
all_dates = df[(df['trade_date'] >= '2025-07-01') & (df['trade_date'] <= '2025-09-30')]['trade_date'].unique()
...
if results:
    ...
    run_id = 'V11_IC_2025Q3_' + datetime.now().strftime('%Y%m%d_%H%M%S')
    ...
    ''', (
        run_id, 'V11_IC_Optimized', '2025-07-01', '2025-09-30', 1000000,
    ...
    df_results.to_csv(f'backtest_results/v11_ic/trades_2025q3_{run_id}.csv', index=False)
